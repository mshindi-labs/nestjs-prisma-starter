...
**Real-world pattern — event handler pre-binding (from YDKJSY):**
...
function partial1<A, B, C, R>(fn: (a: A, b: B, c: C) => R, a: A): (b: B, c: C) => R
...
Reference: [YDKJSY — Closures, Chapter 7 (Partial Application & Currying)](https://github.com/getify/You-Dont-Know-JS/blob/2nd-ed/scope-closures/ch7.md)
