...
```typescript
function memoizeObject<K extends object, R>(
  fn: (key: K) => R
): (key: K) => R {
...
Reference: [YDKJSY — Closures, Chapter 7](https://github.com/getify/You-Dont-Know-JS/blob/2nd-ed/scope-closures/ch7.md)
